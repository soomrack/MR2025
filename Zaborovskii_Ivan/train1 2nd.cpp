...
void alice_clothes (const int year, const int month)
{
...
void alice_monthly_pass (const int year, const int month)
{
...
void bob_clothes(const int year, const int month)
{
...
void bob_monthly_pass(const int year, const int month)
{
