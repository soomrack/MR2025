...
\usepackage{fancyhdr} % Колонтитулы
	...
	\chead{}
	\lhead{}
	\cfoot{\fontsize{14pt}{16pt}\selectfont\thepage}
...
%	\titlespacing*{\subsection}{\parindent}{1ex}{1em}
	...
	\captionsetup[figure]{labelsep = period, font={small,{stretch=1.2}},belowskip=6pt}
...
\usepackage[unicode, colorlinks=true, linkcolor=black, citecolor=black, urlcolor=black, hidelinks=true]{hyperref}
\usepackage[
sorting=nty,
parentracker=true,
backend=biber,
...
\DeclareFieldFormat{urldate}{%
	(дата обращения \iffieldundef{urlyear}{}{\twodigits{\thefield{urlday}}.\twodigits{\thefield{urlmonth}}.\thefield{urlyear}})
}
