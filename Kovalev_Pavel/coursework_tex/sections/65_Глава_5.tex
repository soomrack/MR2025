...
Исходный код проекта размещён в открытом репозитории GitHub \cite{repo}. Для клонирования необходимо выполнить:
...
Проект использует Premake для генерации Makefile-ов. Файл \texttt{premake5.lua} настроен таким образом, что при первом запуске автоматически загружает архив Raylib с GitHub, распаковывает его в папку \texttt{external/} и компилирует статическую библиотеку \cite{premake_docs}. 
