...
Pump shitPump = { SHIT_PUMP_PIN, false}
...
void shit_pump() {
  if (currentMillis - shitPump.lastPumpStart > 86400000UL) {
    shitPump.is_on = true;
    shitPump.lastPumpStart = currentMillis;
  } else if ((currentMillis - shitPump.lastPumpStart > 10000UL) && shitPump.is_on) {
    shitPump.is_on = false;
  }
}
