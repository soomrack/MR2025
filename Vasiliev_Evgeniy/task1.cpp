...
{
    if(month == 10) {
        alice.income = alice.income * 1.08;  // Indexation
    }
...
{
    if (year == 2035 and month == 2) {
        if ((alice.bank_account - alice.car) >= 0) {
            alice.bank_account -= alice.car;
            printf("Alice bought a new car in 2035\n");
        }
        else {
            printf("Alice would not buy a new car in 2035\n");
        }
    }
...
void bob_car(const int year, const int month)
{
    if (year == 2035 and month == 2) {
        if ((bob.bank_account - bob.car) >= 0) {
            ...
            printf("bob bought a new car in 2035\n");
            //printf("bob capital = %d RUB\n", bob.bank_account);
        }
        else {
            printf("bob would not buy a new car in 2035\n");
        }
    }
